         ...
         <div class="top">
				...
				<?php if(isset($_SESSION['usuario_logado'])) : ?>
					...
					<li><a href='deslogar.php' id='menu'>Logout</a>
			   		...
			   		<?php if (isset($_SESSION['foto'])) : ?>
						<li><a href="/conta.php?user=<?php echo $_SESSION['usuario']; ?>"><img src='fotos/<?php echo $_SESSION['foto']['nome']; ?>' width='50px' height='50px' style='-webkit-border-radius:500; -moz-border-radius: 500px; border-radius: 500px; float:right; margin-top:-20px;'></a></li>
					<?php else : ?>
						<li><a href='/conta.php?user=<?php echo $_SESSION['usuario']; ?>'><img src='img/sem-foto.png' width='50px' height='50px' style='-webkit-border-radius:500; -moz-border-radius: 500px; border-radius: 500px; float:right; margin-top:-20px;'></a></li>
					<?php endif; ?>	
			...
			<center>
				...
				<?php if (isset($foto_perfil)) :?>
					<img src='fotos/<?php echo $foto_perfil['nome']; ?>' width="150px" height="150px" style="display:ii; margin-top: 30px; -webkit-border-radius:500; -moz-border-radius: 500px; border-radius: 500px;">
				<?php else : ?>
					<img src='img/sem-foto.png' width="150px" height="150px" style="display:ii; margin-top: 30px; -webkit-border-radius:500; -moz-border-radius: 500px; border-radius: 500px;">
				<?php endif; ?>
					...
					<?php if (count($artes_artista) > 0) : ?>
						...
						<center>
			                <?php
			                    ...
			                    if ($pagina_atual > 1) {
			                        echo "<div class='page-button'><a href='/conta.php?user=$user&page=".($pagina_atual - 1)."'><<</a></div>";
			                    }
			                    ...
			                    for($i = $inicio; $i <= $limite + 1; $i++) {
			                        if ($i == $pagina_atual) {
			                            ...
			                            if ($i >= 1 && $i <= $numPaginas) {
			                                echo "<div class='page-button'><a  id='num-page' href='/conta.php?user=$user&page=$i'>".$i."</a></div> ";
			                            }
			                        }
			                    }
